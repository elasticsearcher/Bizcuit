...
Ext.define("Bizcuit.view.orders.DataView",{
    extend: "Ext.view.View",

    xtype: 'orders-dataview',

    requires: [
        "Bizcuit.view.orders.DataViewController",
        "Bizcuit.view.orders.DataViewModel"
    ],

    controller: "orders-dataview",
    viewModel: {
        type: "orders-dataview"
    },
    ...
    tpl: [
        '<tpl for=".">',
            '<div class="shadow-panel order-tile">',
                ...
                '<span><a href="#orders/{id}">edit</a></span>',
            '</div>',
        '</tpl>',
        {
