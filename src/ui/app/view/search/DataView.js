    ...
    tpl: [
        '<tpl for=".">',
            ...
            '<tpl elseif=\'values._type == "service"\'>',
                ...
                '</div>',
            '<tpl elseif=\'values._type == "category"\'>',
                '<div class="shadow-panel category-tile tile">',
                    '<b>{[this.getHighlightedValue(values, "name")]}</b> <br />',
                    '<p>{[this.getHighlightedValue(values, "description")]}</p>',
                    '<span><a href="#categories/{_id}">edit</a></span>',
                '</div>',
            '<tpl elseif=\'values._type == "invoice"\'>',
                '<div class="shadow-panel invoice-tile tile">',
                    ...
                    '<span><a href="#invoices/{_id}">edit</a></span>',
                '</div>',
            '</tpl>',
        '</tpl>',
        {
